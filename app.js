...
var showQuestion2 = function(answer) {
...
var top_answers = function(user) {
    ...
    .done(function(result) {
            ...
            console.log("request tagged=" + request.tag);
            console.log("top a=" + searchResults);

            $('.search-results').html(searchResults);

            $.each(result.items, function(i, item) {
                var answer = showQuestion2(item);
